...
public abstract class Actor extends Sprite {
	...
	/**
	 * Move this object horizontally as long as it has not reached the left side of the screen. 
	 * If the actor has reached the first column then the Game class is made aware that the 
	 * game should no longer be running.
	 * This method should be called in turns where this actor is allowed to move, 
	 * i.e. it should not be colliding with something else.
	 */
	public void move() {
		// Check to see if the actor has reach
