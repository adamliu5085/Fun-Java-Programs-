...
public class Sprite {
	...
	/**
	 * Checks if the hitbox of this sprite (a), overlaps the hitbox of another
	 * sprite (b). The basic approach is to see if one is totally to the left,
	 * right, above, or below the other sprite. If it is, it is not overlapping.
	 * 
	 * @param a - this sprite
	 * @param b - the other sprite
	 * @return the collision status.
	 */
	public static boolean isOverLapping(Sprite a, Sprite b) {
		if ((a.yPosition + a.size < b.yPosition) // See if this rectangle is above other
				|| (a.yPosition > b.yPosition + b.size) // See if this rectangle is below other
				|| (a.xPosition + a.size < b.xPosition) // See if this rectangle is left of other
				|| (a.xPosition > b.xPosition + b.size)) // See if this rectangle is right of other
			return false;
		// If it is not above or below or left or right of the other, it is colliding.
		return true;
	}
